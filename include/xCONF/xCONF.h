...
typedef struct XCONFList      XCONFList;
...
uint32_t XCONF_createJson(XCONF **__json);
uint32_t XCONF_createSubJson(XCONF *__json, const char *__path, XCONF **sub_json);
uint32_t XCONF_createList(XCONF *__json, const char *__path, XCONFList **list);

uint32_t XCONF_set_float32(XCONF *__json, const char *__path, float32_t value);
uint32_t XCONF_set_float64(XCONF *__json, const char *__path, float64_t value);
uint32_t XCONF_set_float128(XCONF *__json, const char *__path, float128_t value);
uint32_t XCONF_set_float256(XCONF *__json, const char *__path, float256_t value);

uint32_t XCONF_set_uint32(XCONF *__json, const char *__path, uint32_t value);
uint32_t XCONF_set_uint64(XCONF *__json, const char *__path, uint64_t value);
uint32_t XCONF_set_uint128(XCONF *__json, const char *__path, uint128_t value);
uint32_t XCONF_set_uint256(XCONF *__json, const char *__path, uint256_t value);

uint32_t XCONF_set_int32(XCONF *__json, const char *__path, int32_t value);
uint32_t XCONF_set_int64(XCONF *__json, const char *__path, int64_t value);
uint32_t XCONF_set_int128(XCONF *__json, const char *__path, int128_t value);
uint32_t XCONF_set_int256(XCONF *__json, const char *__path, int256_t value);

uint32_t XCONF_set_text(XCONF *__json, const char *__path, const char *text);
uint32_t XCONF_set_object(XCONF *__json, const char *__path, XCONF *sub_json);
uint32_t XCONF_set_list(XCONF *__json, const char *__path, XCONFList *list);

uint32_t XCONF_getValueType(XCONF *__json, const char *__path, enum XCONF_VALUE_TYPE_ENUM *type);

uint32_t XCONF_get_float32(XCONF *__json, const char *__path, float32_t *value);
uint32_t XCONF_get_float64(XCONF *__json, const char *__path, float64_t *value);
uint32_t XCONF_get_float128(XCONF *__json, const char *__path, float128_t *value);
uint32_t XCONF_get_float256(XCONF *__json, const char *__path, float256_t *value);

uint32_t XCONF_get_uint32(XCONF *__json, const char *__path, uint32_t *value);
uint32_t XCONF_get_uint64(XCONF *__json, const char *__path, uint64_t *value);
uint32_t XCONF_get_uint128(XCONF *__json, const char *__path, uint128_t *value);
uint32_t XCONF_get_uint256(XCONF *__json, const char *__path, uint256_t *value);

uint32_t XCONF_get_int32(XCONF *__json, const char *__path, int32_t *value);
uint32_t XCONF_get_int64(XCONF *__json, const char *__path, int64_t *value);
uint32_t XCONF_get_int128(XCONF *__json, const char *__path, int128_t *value);
uint32_t XCONF_get_int256(XCONF *__json, const char *__path, int256_t *value);

uint32_t XCONF_get_text(XCONF *__json, const char *__path, const char **text);
uint32_t XCONF_get_list(XCONF *__json, const char *__path, XCONFList **list);
uint32_t XCONF_get_object(XCONF *__json, const char *__path, XCONF **sub_json);
...
uint32_t XCONFList_set_object(XCONFList *__list, uint32_t index, XCONF *sub_json);
...
uint32_t XCONFList_get_text(XCONFList *__list, uint32_t index, const char **text);
uint32_t XCONFList_get_list(XCONFList *__list, uint32_t index, XCONFList **list);
uint32_t XCONFList_get_object(XCONFList *__list, uint32_t index, XCONF **sub_json);

uint32_t XCONF_keys(XCONF *__json, const char * const *keys, uint32_t *count);
